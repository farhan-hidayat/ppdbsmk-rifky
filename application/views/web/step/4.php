  ...
  <div class="panel-body">
        ...
        <div class="form-group" style="padding-bottom:30px;">
            ...
            <div class="col-sm-9 prepend-icon">
              <input type="text" name="nama_ayah" class="form-control bg-blue" placeholder="Nama lengkap Ayah"  maxlength="100" data-parsley-group="block3" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_ayah"]' required>
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
              <input type="text" name="no_hp_ayah" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="14" placeholder="No. Handphone Ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-no_hp_ayah"]' required>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
        ...
        <div class="form-group" style="padding-bottom:30px;">
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Nama Lengkap <span class="text-danger">*</span></label>
            <div class="col-sm-9 prepend-icon">
              <input type="text" name="nama_ibu" class="form-control bg-blue" placeholder="Nama lengkap Ibu"  maxlength="100" data-parsley-group="block3" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_ibu"]' required>
              <i class="fa fa-user" style="margin-left:15px;"></i>
        ...
        <div class="form-group" >
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">No. Handphone <span class="text-danger">*</span></label>
            <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
              <input type="text" name="no_hp_ibu" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="14" placeholder="No. Handphone Ibu" data-parsley-group="block3" data-parsley-errors-container='div[id="error-no_hp_ibu"]' required>
              <i class="fa fa-phone" style="margin-left:15px;"></i>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
        ...
        <div class="form-group" style="padding-bottom:30px;">
            ...
            <div class="col-sm-9 prepend-icon">
              <input type="text" name="nama_wali" class="form-control bg-blue" placeholder="Nama lengkap Wali"  maxlength="100" data-parsley-group="block3" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_wali"]'>
              <i class="fa fa-user" style="margin-left:15px;"></i>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9" style="margin-top:3px;">
              <select class="form-control bg-blue class" data-placeholder="Pilih Penghasilan Wali" name="penghasilan_wali" data-parsley-group="block3" data-parsley-errors-container='div[id="error-penghasilan_wali"]'>
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
              <input type="text" name="no_hp_wali" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="14" placeholder="No. Handphone Wali" data-parsley-group="block3" data-parsley-errors-container='div[id="error-no_hp_wali"]'>
              <i class="fa fa-phone" style="margin-left:15px;"></i>
