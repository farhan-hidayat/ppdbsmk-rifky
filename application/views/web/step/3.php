<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
        ...
        <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
          <input type="text" name="nis" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="30" placeholder="Nomor Induk Siswa" data-parsley-group="block2" data-parsley-errors-container='div[id="error-nis"]' required>
  ...
  <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" name="nisn" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="30" placeholder="Nomor Induk Siswa Nasional" data-parsley-group="block2" data-parsley-errors-container='div[id="error-nisn"]' required>
        <i class="fa fa-users" style="margin-left:15px;"></i>
  ...
  <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" name="nik" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="30" placeholder="NIK" data-parsley-group="block2" data-parsley-errors-container='div[id="error-nik"]' required>
        <i class="fa fa-users" style="margin-left:15px;"></i>
  ...
  <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="nama_lengkap" class="form-control bg-blue" placeholder="Nama lengkap Calon Siswa" maxlength="100" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_lengkap"]' required>
  ...
  <div class="form-group">
      ...
      <div class="radio" style="margin-top:3px;margin-left:-20px;">
          <label>
          <input type="radio" value="Laki-Laki" name="jk" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="condition-error"]' required> <i class="fa fa-male"></i> &nbsp;Laki-laki
          </label>
        </div>
        <div class="radio" style="margin-left:-20px;">
          <label>
          <input type="radio" value="Perempuan" name="jk" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="condition-error"]' required> <i class="fa fa-female"></i> &nbsp;Perempuan
          </label>
        </div>
  ...
  <div class="form-group">
      ...
      <div class="col-sm-9 prepend-icon" >
        <input type="text" name="tempat_lahir" class="form-control bg-blue class" placeholder="Tempat Kelahiran Calon Siswa" data-parsley-group="block2" data-parsley-errors-container='div[id="error-tempat_lahir"]' required>
 ...
 <div class="form-group" >
    ...
    <div class="col-sm-9" style="margin-top:3px;">
      <div class="col-sm-4" style="padding:0px">
         <select class="form-control bg-blue class"  name="tgl_lahir" data-parsley-group="block2" data-parsley-errors-container='div[id="error-tgl_lahir"]' required>
      ...
      <div class="col-sm-4"  style="padding-left:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih Bulan" name="bln_lahir" data-parsley-group="block2" data-parsley-errors-container='div[id="error-bln_lahir"]' required>
      ...
      <div class="col-sm-4" style="margin-left:-27px;">
         ...
         <select class="form-control bg-blue class" data-placeholder="Pilih Tahun Lahir" name="thn_lahir" data-parsley-group="block2" data-parsley-errors-container='div[id="error-thn_lahir"]' required>
...
<div class="form-group">
    ...
    <div class="col-sm-9" style="margin-top:3px;">
      <select class="form-control bg-blue class" data-placeholder="Pilih Agama yang dianut" name="agama" data-parsley-group="block2" data-parsley-errors-container='div[id="error-agama"]' required>
...
<div class="form-group">
    ...
    <div class="col-sm-9" style="margin-top:3px;">
      <select class="form-control bg-blue class" data-placeholder="Pilih Status dalam Keluarga" name="status_keluarga" data-parsley-group="block2" data-parsley-errors-container='div[id="error-status_keluarga"]' required>
      ...
      <div id="error-status_keluarga" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
              <input type="text" name="alamat_siswa" class="form-control bg-blue class" placeholder="Alamat Calon Siswa" data-parsley-group="block2" data-parsley-errors-container='div[id="error-alamat_siswa"]' required>
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
              <input type="text" name="no_hp_siswa" class="form-control bg-blue class" maxlength="14" onkeypress="return hanyaAngka(this);" placeholder="No. Handphone Calon Siswa" data-parsley-group="block2" data-parsley-errors-container='div[id="error-no_hp_siswa"]' required>
