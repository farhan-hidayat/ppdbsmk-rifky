            ...
            <fieldset class="content-group">
              ...
              <form class="form-horizontal" action="" method="post">
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="nama_jurusan" class="form-control" value="" placeholder="Nama Jurusan" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-lg-3">Kuota</label>
                  <div class="col-lg-9">
                    <input type="number" name="kuota" class="form-control" value="" placeholder="Kuota" required>
                  </div>
                </div>
